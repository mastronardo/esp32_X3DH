...
#elif defined(__APPLE__) || defined(__linux__) || defined(__unix__) || defined(_POSIX_VERSION) || defined(ESP_PLATFORM)
//  On Apple, Linux, UNIX, POSIX or ESP Platform (using gcc) no such marking is required.
#   define IMPORT
#   define EXPORT
#else
